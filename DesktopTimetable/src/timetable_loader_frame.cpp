...
timetable_loader_frame::timetable_loader_frame(const std::function<void()>& manager_refresh_callback): wxFrame(nullptr, wxID_ANY, wxT("Template Manager"), wxPoint(50, 50), wxSize(500, 150)), manager_refresh_callback_(manager_refresh_callback)
{
